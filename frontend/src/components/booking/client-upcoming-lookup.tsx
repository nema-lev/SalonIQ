...
import { CalendarClock, ChevronDown, Loader2, Phone } from 'lucide-react';
    ...
    >
      ...
      >
        <div>
          ...
          <p style={{ margin: '8px 0 0', fontSize: 14, color: 'var(--text-soft)', lineHeight: 1.55 }}>
            Това е отделна справка и не е част от новата резервация.
          </p>
        </div>
        <ChevronDown
          size={18}
